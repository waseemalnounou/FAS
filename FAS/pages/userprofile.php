...
{if($_POST['submit']=='save')
   if($_POST['old']!='' && $_POST['p1']!='' && $_POST['p2']!='')
   {
...
try {
     ...
     $sql = "UPDATE user SET  password='".$_POST["p1"]."' where Id=".$_SESSION['user_Id'];
if (mysqli_query($db, $sql)) {
    ...
    }else{ alert('password not match match');
    }
}else{alert('your old password not courrect');
}
   }else{alert('all fild requierd');}
}
}
}
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                ...
                <div class="row">
                    <div class="col-sm-4">
                    <?php
echo "<lable>Name: </lable>".$user_name."</br>";
echo "<lable>email: </lable>".$email."</br>";
echo "<lable>birthday: </lable>".$Birthday."</br>";
if($Gender==1){echo "<lable>Gender: </lable>Male</br>";}
else{echo "<lable>Gender: </lable>Female</br>";}
?>
                    ...
                    <?php
if($user_Img<>''){
    echo  "<img class='userimg' src="."$user_Img". " alt='user image' height='300' width='300' >";
   
}else
{ 
    echo  '<img  src="\FAS\img\user\user.jpg" class="userimg"  alt="user image" height="300 width="300" />';
    }
     
?>
 <form action="upload.php" method="post" enctype="multipart/form-data">
                          <label>chang Image:</label><input type="file" id="fileToUpload" name="fileToUpload" class="form-control" /></bt>
                        <input type="submit" value="Upload Image" name="submit" class="btn btn-block"/>  
</form>                  
                    </div>
                    <div class="col-sm-4">
                        <form id="myForm" action="userprofile.php" enctype="multipart/form-data" method="post">
                    <label>old password:</label><input value="" name="old" class="form-control" autocomplete="off" type="text"/>
                    <label>new password:</label><input value="" name="p1" class="form-control"  autocomplete="off" type="text"/>
                    <label>repeat password:</label><input value="" name="p2" class="form-control" autocomplete="off" type="text"/>
                      </br>  <input type="submit" value="save" name="submit" class="btn btn-block"/>
                         </form>
                             </div>
                </div>
            <!-- /.row -->
