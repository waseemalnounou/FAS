    ...
    <script src="/FAS/js/index.js"></script>
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <h1 class="page-header">raspberry controle panale</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                <div class="row">
                 <input type="button" value="turn off raspberry" class="btn btn-block" onclick="sy('Turn-off')" />
                 <input type="button" value="reboot raspberry" class="btn btn-block" onclick="sy('reboot')" />
                 <input type="button" value="turn off alarm" class="btn btn-block" onclick="sy('off-falarm')" />
                </div>
            <!-- /.row -->
    ...
    <script>
        function sy(x) {
            ...
            {return;}
                ...
                xmlhttp.open("GET", "http://192.168.1.102/sys.php?c=" + x, true);
                xmlhttp.send();
